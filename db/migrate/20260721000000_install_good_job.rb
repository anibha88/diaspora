...
# Installs the tables GoodJob needs. Mirrors what `bin/rails g good_job:install`
# emits for GoodJob 4.x; if you regenerate against a newer GoodJob release,
# diff the two files and apply any additional columns / indexes.
class InstallGoodJob < ActiveRecord::Migration[6.1]
  def change
